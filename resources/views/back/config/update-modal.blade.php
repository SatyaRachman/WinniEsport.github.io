            ...
            <form action="{{ url('config/'.$item->id) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" class="form-control @error('name')
                        is-invalid @enderror" value="{{ old('name', $item->name) }}" readonly>
                ...
                <div class="mb-3">
                  ...
                  <textarea name="value" id="value" cols="30" rows="5"  class="form-control @error('value')
                  is-invalid @enderror">{{ old('value', $item->value) }}</textarea>
                  @error('value')
                      <div class="invalid-feedback">
                          {{ $message }}
                      </div>
