    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mb-5">
        ...
        <div class="alert alert-danger">
            ...
            <div class="mp-3">
                ...
                <textarea name="desc" id="myeditor" cols="30" rows="10" class="form-control">{{ old('desc',
            ...
            <div class="mp-3">
                ...
                <div class="mt-1">
                    ...
                    <img src="{{ asset('storage/back/'. $article->img) }}" class="img-thumnail img-preview" width="100px">
                </div>
            </div>
